...
Full universe scan -> score everything -> build 7+/14+/30+ watchlists (up
to 5 each = up to 15 Buy rows, fewer if a stock ranks in more than one
horizon) -> evaluate yesterday's ACTIVE trades against today's close for
Hold/Sell -> append tomorrow's Buy list.
"""
